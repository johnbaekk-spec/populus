...
def main() -> int:  # noqa: PLR0915 - a linear acceptance script, deliberately flat
    ...
    # RUN M2-11 R27 added three terms (tail shards + active routing index + v1
    # transition tombstone) to `worst_case_file_count`. This expectation is
    # RESTATED with all three — the
