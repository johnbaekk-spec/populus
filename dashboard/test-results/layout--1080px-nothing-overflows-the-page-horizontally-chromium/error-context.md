...
- Name: layout.spec.ts >> @1080px >> nothing overflows the page horizontally
- Location: test/geometry/layout.spec.ts:73:5

# Error details

```
Error: the page scrolls sideways by 84px at 1080px — widest offender: div.tiles reaching x=1164 against a 1080px viewport
