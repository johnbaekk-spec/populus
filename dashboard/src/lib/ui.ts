...
export function entityTxnTable(txns: TxnRow[], opts: EntityTableOpts): string {
  ...
  return (
    ...
    ` data-paged="1" data-stated-flags="${esc(stated.join(","))}">` +
...
export function changesTableHtml(
  ...
  return (
    ...
    `<div class="table-scroll"><table class="etable" data-sticky-first data-paged="1" data-stated-flags="${esc(statedDeltas.join(","))}">` +
