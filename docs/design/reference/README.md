...
These four unmodified HTML files and support.js came from the user-supplied
“Populus mobile audit round five (1)” export. manifest.json pins their SHA-256
...
For each of Congress, Institutional, Congress Member and Institutional Filer:
...
4. Check mobile/tablet widths, touch targets, focus, notes, scrolling and
   ...
   four routes at 390px and 1440px in design-reference.spec.ts.
